    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(hal83_enchinodermata_5_crino2.this,R.raw.klik);
                mp.start();
                startActivity(new Intent(hal83_enchinodermata_5_crino2.this, hal4_menu_screen.class));
                finish();
            }
        });
    ...
    public boolean onTouchEvent(MotionEvent touchEvent) {
        ...
        switch(touchEvent.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if(x1 < x2){
                    MediaPlayer mp = MediaPlayer.create(hal83_enchinodermata_5_crino2.this,R.raw.sipe);
                    mp.start();
